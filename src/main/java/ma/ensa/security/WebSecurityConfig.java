...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().
                ...
                .antMatchers("/utilisateur/**").access("hasRole('ROLE_CHEF_SERVICE') or hasRole('ROLE_ADMINISTRATEUR') or hasRole('ROLE_EMPLOYE') or hasRole('ROLE_ROOT')")
                .antMatchers("/collaborateur/**").access("hasRole('ROLE_RH') or hasRole('ROLE_ROOT') ")
                .antMatchers("/auth/signup").access("hasRole('ROLE_RH') ")
                .antMatchers("/parametres/*/all*").access("hasRole('ROLE_RH') or hasRole('ROLE_EMPLOYE') or hasRole('ROLE_ADMINISTRATEUR')")
